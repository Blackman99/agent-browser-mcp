...
describe('tool registry', () => {
  it('registers the required public tools', () => {
    ...
    expect(listToolNames()).toContain('click');
    expect(listToolNames()).toContain('tab_list');
    expect(listToolNames()).toContain('eval');
    expect(listToolNames()).toContain('cookies_get');
